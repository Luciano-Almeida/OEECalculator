...
async def update_oee_setup(db: AsyncSession, record_id: int, data: Dict[str, Any]):
    return await update_record(db, OEESetup, record_id, data)

async def update_digest_data(db: AsyncSession, record_id: int, data: Dict[str, Any]):
    return await update_record(db, DigestData, record_id, data)

async def update_planned_downtime_setup(db: AsyncSession, record_id: int, data: Dict[str, Any]):
    return await update_record(db, PlannedDowntimeSetup, record_id, data)

async def update_unplanned_downtime_setup(db: AsyncSession, record_id: int, data: Dict[str, Any]):
    return await update_record(db, UnplannedDowntimeSetup, record_id, data)

async def update_paradas(db: AsyncSession, record_id: int, data: Dict[str, Any]):
    return await update_record(db, Paradas, record_id, data)

async def update_planned_downtime(db: AsyncSession, record_id: int, data: Dict[str, Any]):
    return await update_record(db, PlannedDowntime, record_id, data)

async def update_unplanned_downtime(db: AsyncSession, record_id: int, data: Dict[str, Any]):
    return await update_record(db, UnplannedDowntime, record_id, data)

async def update_auto_oee(db: AsyncSession, record_id: int, data: Dict[str, Any]):
