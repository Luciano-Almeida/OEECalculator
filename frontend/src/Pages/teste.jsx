...
const Teste = ({ selectedParada, tiposDeParada, onSalvarAlteracoes }) => {
  ...
  useEffect(() => {
    if (selectedParada) {
      setObservacao(selectedParada.obs || '');
      setTipoParada(selectedParada.paradaName || '');
    }
  }, [selectedParada]);
  ...
  const handleSalvarAlteracoes = () => {
    ...
    onSalvarAlteracoes({ ...selectedParada, obs: observacao, paradaName: tipoParada });
    setAlteracoesFeitas(false);
  };
      ...
      <div style={{ marginTop: '20px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <Paper sx={{ padding: '16px', backgroundColor: '#f5f5f5', width: '100%' }}>
          ...
          <Typography variant="h6">
            ...
            {selectedParada.paradaType === 'planejada' ? 'Planejada' : 'Não Planejada'}
          </Typography>
